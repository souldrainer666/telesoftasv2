...
import static gildedrose.quality.QualityControlFactory.BACKSTAGE_PASS_ITEM_NAME;
...
public class GreetingControllerTests {
    ...
    public void testFewItems() throws Exception {
        ...
        this.mockMvc.perform(get("/details")
                .param("name", BACKSTAGE_PASS_ITEM_NAME))
                .andDo(print()).andExpect(status().isOk())
                .andExpect(jsonPath("$.[0].name").value(BACKSTAGE_PASS_ITEM_NAME))
